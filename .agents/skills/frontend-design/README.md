...
## Usage
Examples of prompts that trigger this skill:
...
## Authors
Prithvi Rajasekaran ([prithvi@anthropic.com](mailto:prithvi@anthropic.com)) Alexander Bricken ([alexander@anthropic.com](mailto:alexander@anthropic.com))
